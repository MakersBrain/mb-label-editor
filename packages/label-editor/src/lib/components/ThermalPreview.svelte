...
<style>canvas{position:absolute;inset:0;width:100%;height:100%;image-rendering:pixelated;pointer-events:none;z-index:0}.error{position:absolute;right:.3rem;bottom:.3rem;background:#fff8;color:#a21;font-size:9px;z-index:2}</style>
